...
- **جزئیات**
  ...
  ناظر خطا سه آرگومان را دریافت می‌کند: خطا، نمونه کامپوننتی که باعث خطا شد، و یک رشته اطلاعات که نوع منبع خطا را مشخص می‌کند.
