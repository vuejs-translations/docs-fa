...
- **مثال**
  ...
  هنگام استفاده از امضای پراپرتی شی، `toRef()` یک ref قابل استفاده برمی‌گرداند حتی اگر پراپرتی منبع در حال حاضر وجود نداشته باشد. این کار با پراپرتی‌های اختیاری را ممکن می‌سازد، که توسط [`toRefs`](#torefs) قابل دریافت نیستند.
