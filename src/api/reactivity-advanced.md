...
اگر این تابع بدون یک دامنه اثر فعال فراخوانی شود، هشدار داده می‌شود. در نسخه ۳.۵+، این هشدار را می‌توان با ارسال مقدار `true` به عنوان آرگومان دوم غیرفعال کرد.
