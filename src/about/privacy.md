...
- **داده‌های استفاده از قابلیت جستجو.** قابلیت جستجو‌ی ما توسط [Algolia DocSearch](https://docsearch.algolia.com/) انجام می‌شود، که هیچ نوع رهگیری یا fingerprinting از کاربر انجام نمی‌دهد و از cookie ها استفاده نمی‌کند. سرویس‌های Algolia از GDPR و CCPA پیروی می‌کنند و دارای گواهی TRUSTe هستند.
