...
- عدم مقداردهی پراپ تایپ منطقی (boolean types) مقدار `false` خواهد داشت. می‌توان این تنظیمات را با مقداردهی مقدار پیش فرض تغییر داد. `default: undefined` تا رفتاری مانند تایپ‌های non-Booleanها داشته باشد.
