...
این روش در نسخه های قبل از 3.5 کار می کند. علاوه بر این، `onCleanup` که از طریق آرگومان تابع ارسال می‌شود به نمونه تماشاگر محدود می‌شود، بنابراین تحت محدودیت هم‌زمان بودن `onWatcherCleanup` قرار نمی‌گیرد.
...
### ناظران همگام‌سازی‌شده {#sync-watchers}
