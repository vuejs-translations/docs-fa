...
[`create-vue`](https://github.com/vuejs/create-vue) ابزار رسمی ساختاردهی پروژه، گزینه‌هایی را برای یک پروژه Vue که از [Vite](https://vite.dev/) قدرت گرفته و آماده برای تایپ‌اسکریپت است ارائه می‌دهد.
